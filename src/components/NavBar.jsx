                        ...
                        <ul className="md:flex gap-8 hidden items-center text-[1rem]">
                            ...
                            <li>
                                <NavLink style={{ textDecoration: "none" }} to="/collection">
                                    {({ isActive }) => (
                                        <span className={`hover:underline decoration-2 font-medium underline-offset-4 decoration-purple-500 ${isActive ? "text-purple-500 font-medium" : "text-yellow-100"}`}>EASY BUY</span>
                                    )}
                                </NavLink>
                            </li>
                        </ul>
