            ...
            <div className="absolute inset-0">
                <div className='min-h-screen  flex lg:flex-row md:flex-row flex-col pt-10 relative px-6'>
                    ...
                    <div className='z-20'>
                        ...
                        <h1 className='lg:text-8xl md:text-6xl text-5xl font-medium mt-4'>Zorotocol</h1>
                        <h1 className='lg:text-8xl md:text-6xl text-5xl mt-2 text-purple-500 font-medium'>Buy VPN with crypto peyment</h1>
                        <p className='text-lg my-5'>NEW WAY TO <span className='text-purple-500'>BUY VPN</span> </p>
                        ...
                        <div className='flex gap-5'>
                            <button className='bg-purple-600 px-4 py-1.5 rounded-md text-sm'>EASY BUY 😎</button>
                            <button className='border px-4 py-1.5 text-sm rounded-md'>ABOUT US 👁️</button>
                        </div>
                    </div>
